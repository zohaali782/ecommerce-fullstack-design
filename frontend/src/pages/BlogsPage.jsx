      ...
      <div className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="text-center max-w-md w-full">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mb-3">
            NexMart Blog is on its way
          </h1>
          <p className="text-sm text-gray-500 leading-relaxed mb-8">
            We are working on guides, buying tips, and supplier insights. Drop
          ...
          {!submitted ? (
            <div className="flex gap-2 max-w-sm mx-auto">
              <input
                ...
                className="flex-1 border border-gray-300 rounded-l px-3 py-2 text-sm focus:outline-none focus:border-blue-500"
              />
              <button
                onClick={handleNotify}
                className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-r text-sm font-medium shrink-0 transition-colors"
              >
                Notify me
              </button>
            </div>
          ) : (
            <div className="flex items-center justify-center gap-2 bg-green-50 border border-green-200 rounded-lg px-4 py-3 max-w-sm mx-auto">
              <svg
